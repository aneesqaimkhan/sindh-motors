...
<head>
  ...
  <style>
    ...
    .brand-title{
      font-family:'Playfair Display', serif; letter-spacing:.5px; color:var(--platinum-dark); font-size:14px;
    }

    .headline{ font-family:'Playfair Display', serif; color:var(--platinum-dark); font-weight:700; letter-spacing:1px; font-size:18px; }
    .subhead{ font-weight:700; color:var(--platinum-dark); font-size:12px; }

    .divider{ height:2px; background:linear-gradient(to right, transparent, var(--platinum-dark), transparent); margin:8px 0 10px; opacity:.8; }
    ...
    .badge{
      ...
      border:2px solid var(--platinum-dark); box-shadow:0 4px 12px rgba(181,181,181,.35); font-size:11px;
    }
      ...
      <div class="frame">
        ...
        <div class="text-center mt-1">
          <div class="position-relative mb-2">
            ...
            <div class="registration-number" style="position: absolute; left: 0; top: 50%; transform: translateY(-50%); font-size: 10px; font-weight: bold; color: var(--platinum-dark); padding-left: 5px;">
              Reg #: <?= esc($member['member_registration_number'] ?? '') ?>
            </div>
            
            <!-- Membership Card Headline - Center -->
            <div class="headline m-0">PLATINUM MEMBERSHIP</div>
          ...
          <div class="subhead">PLATINUM MEMBER ID</div>
          <div class="divider"></div>
          <p class="mb-1" style="font-size: 11px;">This platinum card is issued to</p>
