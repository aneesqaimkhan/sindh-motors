  ...
  <style>
    ...
    @media print{
      ...
      .showroom-info-section {
        ...
        background: linear-gradient(135deg, var(--light-blue), #f0f7fd) !important;
    ...
    <div class="certificate">
      <div class="frame">
        <div class="d-flex align-items-center justify-content-center mb-3">
          <div class="brand-title h3 m-0">Qasimabad Car Showrooms Association</div>
        </div>

        <div class="text-center mt-1">
          <div class="position-relative mb-2">
            <!-- Registration Number - Float Left -->
            <div class="registration-number" style="position: absolute; left: 0; top: 50%; transform: translateY(-50%); font-size: 16px; font-weight: bold; color: var(--blue-1); padding-left: 10px;">
              Registration #: <?= esc($showroom['showroom_registration_number'] ?? '') ?>
            </div>
            
            <!-- Certificate Headline - Center -->
            <div class="headline display-6 m-0">CERTIFICATE</div>
          ...
          <div class="subhead fs-5">OF REGISTRATION</div>
          <div class="divider"></div>
          <p class="mb-2">This certificate is proudly presented to</p>
          <p class="mb-2">Showroom Registration Awarded To</p>
          <div class="recipient" id="recipientName"><?= esc($showroom['name']) ?></div>
          <p class="mt-2 mb-1 text-muted">In recognition of their commitment to excellence in the automotive community and adherence to QCSA standards.</p>
          <span class="badge mt-1">
            ...
            QCSA - <?= ucfirst($showroom['category']) ?> Member
          </span>
        </div>

        <!-- Showroom Details Section -->
        <div class="mt-3 p-2 showroom-info-section" style="background: linear-gradient(135deg, var(--light-blue), #f0f7fd); border-radius: 8px; border: 2px solid var(--gold-2);">
          <h6 class="text-center mb-2" style="color: var(--blue-1); font-weight: bold;">Showroom Information</h6>
          <div class="row g-2">
            <div class="col-md-6">
              <div class="d-flex align-items-center">
                <strong style="color: var(--blue-1); min-width: 140px;">CNIC No:</strong>
                <span style="color: var(--ink);"><?= esc($showroom['cnic_no'] ?? '') ?></span>
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-flex align-items-center">
                <strong style="color: var(--blue-1); min-width: 140px;">Mobile Number:</strong>
                <span style="color: var(--ink);"><?= esc($showroom['cell_no'] ?? $showroom['phone'] ?? '') ?></span>
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-flex align-items-center">
                <strong style="color: var(--blue-1); min-width: 140px;">Showroom Name:</strong>
                <span style="color: var(--ink);"><?= esc($showroom['showroom_name'] ?? '') ?></span>
              </div>
            </div>
            <div class="col-md-6">
              <div class="d-flex align-items-center">
                <strong style="color: var(--blue-1); min-width: 140px;">Address:</strong>
                <span style="color: var(--ink);"><?= esc($showroom['showroom_address'] ?? '') ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row meta-row g-3 align-items-end">
          ...
          <div class="col-4">
            ...
            <div class="small mt-2">Muhammad Yaseen Beharn (PRESIDENT)</div>
          </div>
          <div class="col-3 ps-3">
            
            <div class="small mt-2" id="issueDateLine"></div>
            <div class="meta-line"></div>
