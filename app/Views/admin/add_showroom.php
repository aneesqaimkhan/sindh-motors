        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Add New Showroom</h5>
                </div>
                <div class="card-body">
                    <form action="<?= base_url('admin/addShowroom') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="cnic_no" name="cnic_no" 
                                       value="<?= old('cnic_no') ?>" placeholder="0000000000000" maxlength="13" required>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="cell_no" class="form-label">Cell Number *</label>
                                <input type="text" class="form-control" id="cell_no" name="cell_no" 
                                       value="<?= old('cell_no') ?>" placeholder="03000000000" maxlength="11" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" id="category" name="category" required>
                                    ...
                                    <option value="golden" <?= old('category') == 'golden' ? 'selected' : '' ?>>Golden</option>
                                                    ...
                                                    <div class="col-md-11">
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="members[0][member_name]" name="members[0][member_name]" 
                                                                       value="<?= old('members.0.member_name') ?>" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="members[0][father_name]" class="form-label">Father Name *</label>
                                                                <input type="text" class="form-control" id="members[0][father_name]" name="members[0][father_name]" 
                                                                       value="<?= old('members.0.father_name') ?>" required>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-4 mb-3">
                                                                <label for="members[0][cnic_no]" class="form-label">CNIC No *</label>
                                                                <input type="text" class="form-control" id="members[0][cnic_no]" name="members[0][cnic_no]" 
                                                                       value="<?= old('members.0.cnic_no') ?>" placeholder="0000000000000" maxlength="13" required>
                                                            </div>
                                                            <div class="col-md-4 mb-3">
                                                                <label for="members[0][cell_no]" class="form-label">Cell No *</label>
                                                                <input type="text" class="form-control" id="members[0][cell_no]" name="members[0][cell_no]" 
                                                                       value="<?= old('members.0.cell_no') ?>" placeholder="03000000000" maxlength="11" required>
                                                            </div>
                                                            <div class="col-md-4 mb-3">
                                                                ...
                                                                <select class="form-control" id="members[0][blood_group]" name="members[0][blood_group]">
                                                                    <option value="A+" <?= old('members.0.blood_group') == 'A+' ? 'selected' : '' ?>>A+</option>
                                                                    <option value="A-" <?= old('members.0.blood_group') == 'A-' ? 'selected' : '' ?>>A-</option>
                                                                    <option value="B+" <?= old('members.0.blood_group') == 'B+' ? 'selected' : '' ?>>B+</option>
                                                                    <option value="B-" <?= old('members.0.blood_group') == 'B-' ? 'selected' : '' ?>>B-</option>
                                                                    <option value="AB+" <?= old('members.0.blood_group') == 'AB+' ? 'selected' : '' ?>>AB+</option>
                                                                    <option value="AB-" <?= old('members.0.blood_group') == 'AB-' ? 'selected' : '' ?>>AB-</option>
                                                                    <option value="O+" <?= old('members.0.blood_group') == 'O+' ? 'selected' : '' ?>>O+</option>
                                                                    <option value="O-" <?= old('members.0.blood_group') == 'O-' ? 'selected' : '' ?>>O-</option>
                                                                </select>
                                                            </div>
                                                        </div>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Add Showroom
                            </button>
                        </div>
                    </form>
                </div>
